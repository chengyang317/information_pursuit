def define_ConvNet_layers(shape, net_percent):
    layers_attrs = {'input_layer': {'layer_name': 'input', 'shape': shape},
                    ...
                    'pool1_layer': {'layer_name': 'pool1', 'ksize': [1, 3, 3, 1], 'strides': [1, 2, 2, 1],
                                    'padding': 'SAME'},
                    'conv2_layer': {'layer_name': 'conv2', 'shape': [5, 5, int(96 * net_percent),
                                                                     int(256 * net_percent)], 'stddev': 1e-2,
                                    'strides': [1, 2, 2, 1], 'padding': 'SAME', 'biase': 0.1},
                    ...
                    'pool2_layer': {'layer_name': 'pool2', 'ksize': [1, 3, 3, 1], 'strides': [1, 2, 2, 1],
                                    'padding': 'SAME'},
                    'conv3_layer': {'layer_name': 'conv3', 'shape': [3, 3, int(256 * net_percent),
                                                                     int(256 * net_percent)], 'stddev': 1e-2,
                                    'strides': [1, 2, 2, 1], 'padding': 'SAME', 'biase': 0.1},
                    ...
                    'loss_layer': {'layer_name': 'loss', 'weight_decay': 0.1, 'net_tensors': None,
                                   'includes': ['conv1_kernel', 'conv2_kernel', 'conv3_kernel', 'full4_kernel',
                                                'softmax5_kernel']},
                    'train_layer': {'layer_name': 'train', 'learn_rate': 0.1},
                    'eval_layer': {'layer_name': 'eval'},
                    'aux_layer': {'layer_name': 'aux'}
                    }
    return layers_attrs